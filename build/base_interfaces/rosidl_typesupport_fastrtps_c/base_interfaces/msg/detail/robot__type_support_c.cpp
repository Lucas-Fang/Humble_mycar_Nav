...
#include "base_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_c.h"
...
using _Robot__ros_msg_type = base_interfaces__msg__Robot;
...
size_t get_serialized_size_base_interfaces__msg__Robot(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name v_omega
  {
    size_t item_size = sizeof(ros_message->v_omega);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Robot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces__msg__Robot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t max_serialized_size_base_interfaces__msg__Robot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces__msg__Robot;
    is_plain =
      (
      offsetof(DataType, v_omega) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Robot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces__msg__Robot(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, msg, Robot)() {
