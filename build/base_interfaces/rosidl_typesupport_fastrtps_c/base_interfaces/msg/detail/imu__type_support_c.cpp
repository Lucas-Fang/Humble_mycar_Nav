...
#include "base_interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _Imu__ros_msg_type = base_interfaces__msg__Imu;
...
size_t get_serialized_size_base_interfaces__msg__Imu(
  const void * untyped_ros_message,
...
static uint32_t _Imu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_interfaces__msg__Imu(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_interfaces
size_t max_serialized_size_base_interfaces__msg__Imu(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces__msg__Imu;
    is_plain =
      (
...
static size_t _Imu__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_interfaces__msg__Imu(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_interfaces, msg, Imu)() {
