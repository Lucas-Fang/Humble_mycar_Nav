...
{
  new (message_memory) base_interfaces::msg::Imu(_init);
}

void Imu_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_interfaces::msg::Imu *>(message_memory);
  typed_message->~Imu();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Imu_message_member_array[3] = {
  {
    ...
    offsetof(base_interfaces::msg::Imu, roll),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces::msg::Imu, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces::msg::Imu, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Imu_message_members = {
  ...
  "Imu",  // message name
  3,  // number of fields
  sizeof(base_interfaces::msg::Imu),
...
get_message_type_support_handle<base_interfaces::msg::Imu>()
{
  return &::base_interfaces::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interfaces, msg, Imu)() {
  return &::base_interfaces::msg::rosidl_typesupport_introspection_cpp::Imu_message_type_support_handle;
}
