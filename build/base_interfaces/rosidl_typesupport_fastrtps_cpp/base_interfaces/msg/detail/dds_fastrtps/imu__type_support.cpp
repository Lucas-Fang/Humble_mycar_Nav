...
#include "base_interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces::msg::Imu & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces::msg::Imu & ros_message)
{
  // Member: roll
  cdr >> ros_message.roll;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_interfaces::msg::Imu;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  return &base_interfaces::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces, msg, Imu)() {
  return &base_interfaces::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
