...
{
  new (message_memory) base_interfaces::msg::Robot(_init);
}

void Robot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<base_interfaces::msg::Robot *>(message_memory);
  typed_message->~Robot();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Robot_message_member_array[3] = {
  {
    ...
    offsetof(base_interfaces::msg::Robot, v_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces::msg::Robot, v_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(base_interfaces::msg::Robot, v_omega),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Robot_message_members = {
  ...
  "Robot",  // message name
  3,  // number of fields
  sizeof(base_interfaces::msg::Robot),
...
get_message_type_support_handle<base_interfaces::msg::Robot>()
{
  return &::base_interfaces::msg::rosidl_typesupport_introspection_cpp::Robot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interfaces, msg, Robot)() {
  return &::base_interfaces::msg::rosidl_typesupport_introspection_cpp::Robot_message_type_support_handle;
}
